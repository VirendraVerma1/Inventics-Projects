...
@section('content')
<div class="container">
<h3 class="title">Tag List<a style="text-decoration:none;" href="#" onclick="create()">+</a></h3>
...
<table class="table table-striped">
  ...
  <td>
  <a class="btn btn-info btn-sm" href="#" onclick="edit({{$tag}})">edit</a>
  <form action="{{route('tag.destroy',$tag)}}"method="post">
    @csrf()
    @method('delete')
    <button class="btn btn-danger btn-sm"  onclick="deleteit({{$tag}})" type="submit">Delete</button>
  </form>
  </td>
  </tr>
  @endforeach
