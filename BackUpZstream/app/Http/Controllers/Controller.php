...
class Controller extends BaseController
{
    ...
    public $ZShop_base_url="http://zcommerce.online/";
    public $EthenicBazaar_base_url="https://www.ethnicbazaar.com/";
    ...
    public function get_responseDataFromURLPost($data,$url,$decode=false)
    {
        $curl = curl_init();
