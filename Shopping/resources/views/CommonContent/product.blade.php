          ...
          <div class="prd prd--style2 prd-labels--max prd-labels-shadow ">
            <div class="prd-inside">
              <div class="prd-img-area">
                ...
                @endif
                  <a  class="circle-label-qview prd-hide-mobile" onclick="document.getElementById('quick_view_Modal').style.display='block'"><i class="icon-eye"></i><span>QUICK VIEW</span></a>
                </div>
              </div>
              <div class="prd-info">
                ...
                <div class="prd-hovers">
                  <div class="prd-circle-labels">
                    ...
                    <div class="prd-hide-mobile"><a href="#" class="circle-label-qview " onclick="document.getElementById('quick_view_Modal').style.display='block'"><i class="icon-eye"></i><span>QUICK VIEW</span></a></div>
                  </div>
                  <div class="prd-price">
