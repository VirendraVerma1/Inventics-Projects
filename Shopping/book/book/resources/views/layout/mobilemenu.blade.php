<div class="header-side-panel">
    ...
    <div class="dropdn-content-block">
      <div class="dropdn-close"><span class="js-dropdn-close">Close</span></div>
        <div class="dropdn-form-wrapper" id="dropdonAccountlogin">
        <ul>
          @if (Route::has('login'))
            @auth
              <li>
                <b><span>Hello, {{Auth::user()->name }}</span></b>
              </li>
              <li>
                <a href="{{ route('Account','details') }}"><span class="icon-user2">&emsp;My Account</span></a>
              </li>
              <li>
                <a href="{{ route('Account','orders') }}"><span class="icon-cart">&emsp;My Orders</span></a>
              </li>
              <li>
                <a href="{{ route('Account','wishlist') }}"><span class="icon-wishlist">&emsp;My Wishlist</span> </a>
              </li>
              <li>
                <a href="{{ route('Cart') }}"><span class="icon-cart">&emsp;My Cart</span> </a>
              </li>
              <li class="sep"><hr></li>
              <li><a href="{{ route('logout') }}"onclick="event.preventDefault();document.getElementById('logout-form').submit();"><span class="icon-login">&emsp;{{ __('Logout') }} </span></a>
            ...
            @else
              ...
              @if (Route::has('register'))  
                <li><a href="{{route('account_create')}}"><span>Register</span><i class="icon-user2"></i></a></li>
              @endif
              <hr>
              <div id="otplogin-form" >
                <div class="dropdn-form-wrapper">
                  <h5>Quick Login</h5>
                  <div id="RequestLoginOtp">
                      <div class="form-group has-feedback">
                          <input type="number" id="loginphone" name="phone"  class="form-control input-lg"  required placeholder="Enter Mobile Number">
                      </div>
                      <div class="row has-feedback pl-2">
                          <a href="#" class="btn" id="request_otp">Verify Number</a>         
                      </div>
                  </div>
                  <div id="EnterLoginOtp" style="display:none;">   
                      <form action="{{route('verify_login_otp')}}" method="POST">  
                          @csrf             
                            <div class="form-group has-feedback">
                                <input type="text" id="verifyphone" name="phone" value="phone number" class="form-control input-lg" required>
                                <span class="glyphicon glyphicon-phone form-control-feedback"></span>
                                <div class="help-block with-errors"></div>
                            </div>
                            <div class="form-group has-feedback">
                                <input type="number" id="otp_password" name="password"  class="form-control input-lg" placeholder="Enter OTP" data-minlength="4" required>                            
                                <span class="glyphicon glyphicon-lock form-control-feedback"></span>
                                <div class="help-block with-errors"></div>
                                <span class="text-danger">OTP has been sent to the above number</span>
                            </div>
                            <div class="row">
                                <div class="col-xs-5 pl-2">
                                    <button type="submit" class="btn" >Login</button>
                                </div>
                                <div class="col-xs-5 pl-2 pt-1">
              ...
              <hr>
              <h6>Don't have account yet? <a href="#" id="register_now" style="color:#0000FF;">Register Now</a></h6>
            @endauth
          @endif
        </ul> 
        </div>
        <div id="dropdonAccountRegister" style="display:none">
            <div class="container">
                <div class="row justify-content-center ">
                  <h2 class="text-center">Create an Account</h2>
                  <div class="form-wrapper">
                    <div class="text-danger" id="notRegistered"><p>Please fill the below details</p></div>
                    <p class="px-2">To access your whishlist, address book and contact preferences and to take advantage of our speedy checkout, create an account with us now.</p>
                      
                      <div class="row">
                        <div class="col">
                          <div class="form-group">
                            <input placeholder="Full name" id="name" type="text" class="form-control " name="name" value="{{ old('name') }}" required>
                            <span class='text-danger'id="eroor-regname"></span>
                          </div>
                        </div>
                      </div>

                      <div class="form-group">
                          <input id="registerphone" type="number" name="phone" value="" class="form-control" required placeholder="Mobile Number">
                          <span class='text-danger'id="eroor-regphone"></span>
                      </div>

                      <div class="form-group">
                        <input id="email" type="email" class="form-control " name="email" value="{{ old('email') }}" required placeholder="E-mail">
                        <span class='text-danger'id="eroor-regemail"></span>
                      </div>

                      <div class="form-group">
                        <input id="regpassword" type="password" class="form-control " name="password" required placeholder="Password">
                        <span class='text-danger'id="eroor-regpassword"></span>
                      </div>
                      
                      <div class="form-group">
                        <input id="password-confirm" type="password" class="form-control" name="password_confirmation" required placeholder="Confirm Password">
                        <span class='text-danger'id="eroor-regcnfpassword"></span>
                      </div>
                      ...
                      <div class="clearfix">
                        ...
                        <!-- <span class='text-danger'id="eroor-regtnc"></span> -->
                      </div>

                      <div class="text-center">
                        <button type="submit" id="submit-registerRequest" class="btn btn-primary">create an account</button>
                      </div>
                      <br>
                  </div>
                </div>
                <br>
                <hr>
                <h6>have account&emsp;<a href="#" id="loginNow" style="color:#0000FF;"><span>login Now</span></a></h6>
            </div>
        </div>
      </div>
      ...
      <div class="dropdn-content-block">
        ...
        <div class="minicart-drop-fixed js-hide-empty">
          ...
          <div class="minicart-drop-total js-minicart-drop-total row no-gutters align-items-center">
            ...
            <div class="minicart-drop-total-price col" data-header-cart-total="" id="minicart_subtotal">$340</div>
          </div>
